 ...
 * to view stacks in a different region than their active connection.
 */
@Service(Service.Level.APP)
@State(name = "cfnExplorerRegion", storages = [Storage("aws.xml", roamingType = RoamingType.DISABLED)])
